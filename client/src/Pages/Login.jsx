...
export default function Login() {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" dir="rtl">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center mb-8">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400 via-blue-500 to-yellow-600 rounded-full blur-2xl opacity-30 animate-pulse"></div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-3 bg-gradient-to-r from-blue-600 to-yellow-600 bg-clip-text text-transparent">
              مرحباً بعودتك
            </h2>
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-blue-200/50 dark:border-blue-700/50 transform hover:scale-[1.02] transition-all duration-500">
            <form onSubmit={onLogin} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group relative w-full flex justify-center py-4 px-6 border border-transparent text-lg font-semibold rounded-xl text-white bg-gradient-to-r from-blue-600 via-blue-500 to-yellow-600 hover:from-blue-700 hover:via-blue-600 hover:to-yellow-700 focus:outline-none focus:ring-4 focus:ring-blue-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl shadow-lg overflow-hidden"
              >
