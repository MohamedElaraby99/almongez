            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  مرحباً بك في نظام إدارة التعلم من Almongez. من خلال الوصول إلى منصتنا واستخدامها، 
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    مملوك لشركة Almongez أو المرخصين لها ومحمي بقوانين حقوق النشر.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300">
                    تقدم شركة Almongez المحتوى التعليمي والخدمات "كما هي" دون ضمانات.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <section className="mb-8">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                  ...
                  <div className="space-y-1 text-gray-700 dark:text-gray-300">
                    ...
                    <p><strong>الموقع الإلكتروني:</strong> https://almongz.online/</p>
                  </div>
                </div>
              </section>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-8">
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  من خلال استخدام منصة شركة Almongez، فإنك تقر بأنك قد قرأت وفهمت 
